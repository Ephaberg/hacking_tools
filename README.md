...
### !! RUN hacking_tools AS ROOT !! 


## Steps are given below : 


## Step : 1 Download hacking_tools

    git clone https://github.com/Ephaberg/hacking_tools.git

## Step : 2 Give Permission to hacking_tools
    
    chmod -R 755 hacking_tools  

## Step : 3 Move to hacking_tools directory

    cd hacking_tools

## Step : 4 Run hacking_tools
...
```bash
docker buitl -t vgpastor/hacking_tools .
```
...
```bash
docker exec -it hacking_tools bash
```
**OUTPUT:**
```bash
Select Best Option : 
...
##### Your Favourite Tool is not in hacking_tools or Suggestions Please [CLICK HERE](https://forms.gle/b235JoCKyUq5iM3t8)
